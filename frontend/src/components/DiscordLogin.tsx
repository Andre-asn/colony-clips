    ...
    <div className="min-h-screen bg-[#2c2f33] flex items-center justify-center p-4">
      <div className="bg-[#36393f] rounded-lg p-8 w-full max-w-md border border-[#202225]">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 bg-[#5865f2] hover:bg-[#4752c4] text-white font-medium rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
        >
